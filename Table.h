...
// add private data and methods here
	...
	unsigned int occupiedBucket() const; // return the number of non-empty buckets
	unsigned int longestChain() const; // return the length of the longest chain
	unsigned int hashSize;	// size of the hash table (used in hashCode method above)						
	unsigned int numOfEntries; // number of entires
	ListType * data; //used to store lists
